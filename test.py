...
data_root = op.join(root_path, 'Pack50Dataset')
...
arg = {
    ...
    'output_folder': op.join(output_path, f'{shape_name}'),
    'shape': shape_name,
    'mixing_file': op.join(config_path, f'stretch_{shape_name}.yaml'),
}
...
#    'output_folder': op.join(output_path, f'{shape_name}'),
#    'shape': shape_name,
#    'transform_file': op.join(config_path, f'stretch_{shape_name}.yaml'),
#}
#agent('shape_transform', arg)
#print('time cost: ', time()-t0)
