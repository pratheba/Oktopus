...
class LossHandler():
    ...
    def dist_base_loss(
        ...
        out_base  = output['dist_base']
        out_base1 = output['dist_base1']
        gt_base   = gt['dist_base'].view_as(out_base)
    ...
    def dist_loss(
        ...
        out_base      = output['dist_base']
        out_base1     = output['dist_base1']
        out_base2     = output['dist_base2']
        out_detail    = output['dist_detail']
        gate_base2    = output['gate_base2']
        gate_detail   = output['gate_detail']

        gt_sdf  = gt['dist'].view_as(out_sdf)
        gt_base = gt['dist_base'].view_as(out_base)
        gt_res  = gt['dist_res'].view_as(out_sdf)
...
#            )
    ...
    def dist_query_loss(self, output, gt, metric_fn):
        out_sdf = output['dist']
        gt_sdf = gt['dist'].view_as(out_sdf)
        return metric_fn(out_sdf, gt_sdf)
