    ...
    def __inference_vals(self, curve_data, context_data, key, batch_size=None):
        ...
        if batch_size is not None and num_samples > batch_size:
            ...
            for batch in batches:
                ...
                r = np.random.choice(num_context_samples, size=2048, replace=True)
                ...
                trimesh.Trimesh(vertices=batch_curve_data['samples_local'], process = False).export(str(self.feat_dict[key])+'_query.ply')
