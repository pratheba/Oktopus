...
from periodic_encoding import PeriodEncoding
...
class NGCNet(nn.Module):
    ...
    def __init__(self, arg):
        ...
        self.periodic_enc = PeriodEncoding(arg['num_period_encoding'])
